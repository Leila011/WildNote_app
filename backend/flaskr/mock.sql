...
INSERT INTO experiment_attributes (experiment_attributes_id, name, type, custom, experiment_id) VALUES
(1, 'Name', 'TEXT', 0, 1),
(2, 'Creation Date', 'TEXT', 0, 1),
(3, 'Name', 'TEXT', 0, 2),
(4, 'Creation Date', 'TEXT', 0, 2),
(5, 'Name', 'TEXT', 0, 3),
(6, 'Creation Date', 'TEXT', 0, 3);

-- Insert mock data into sample_attributes table
INSERT INTO sample_attributes (sample_attributes_id, name, type, custom, experiment_id) VALUES
(1, 'Start', 'TEXT', 0, 1),
(2, 'End', 'TEXT', 0, 1),
(3, 'Start', 'TEXT', 0, 2),
(4, 'End', 'TEXT', 0, 2),
...
INSERT INTO observation_attributes (observation_attributes_id, name, type, custom, experiment_id) VALUES
(1, 'Start', 'TEXT', 0, 1),
(2, 'End', 'TEXT', 0, 1),
(3, 'Start', 'TEXT', 0, 2),
(4, 'End', 'TEXT', 0, 2),
...
INSERT INTO subject_attributes (subject_attributes_id, name, type, custom, experiment_id) VALUES
(1, 'Name', 'TEXT', 0, 1),
(2, 'Name', 'TEXT', 0, 2),
(3, 'Name', 'TEXT', 0, 3),
(4, 'Age', 'INTEGER', 1, 1),
